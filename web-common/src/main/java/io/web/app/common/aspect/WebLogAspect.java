package io.web.app.common.aspect;
...
@Slf4j
@Component
@ConditionalOnExpression("'${api.component.items}'.contains('webLog')")
public class WebLogAspect {
     ...
     */
    @Around("execution(* io..controller..*.*(..))")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        RequestHolder.RequestInfo requestInfo = RequestHolder.get();
